            ...
            <div class="search_navigation_parameters w-full">
                <div class="w-full flex gap-4 items-center">
                    <div class="w-[50%]  flex flex-col gap-2">
                        ...
                        <input class="border border-black py-2 px-2 outline-none" type="text" name="searchDestination" id="searchDestination" value="{{ $destination ?? '' }}" placeholder="Rechercher une destination" required>
                    ...
                    <div class="w-full flex flex-col gap-2">
                        ...
                        <div class="w-full flex  gap-2">
                            ...
                            <!-- nombres chambres -->
                            <div class="  chambre_btn cursor-pointer  rounded-[5px] ">
                ...
                <div class="w-full flex justify-end">
                    <button class="w-[30%] bg-[rgb(16,76,151)] py-2 text-white rounded-[5px] px-4 text-[13px]" type="submit">Trouver un hotel</button>
                </div>
